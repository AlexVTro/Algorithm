...
Partial Class Help1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "ѕуть к папке с XML файлами"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "ѕуть к папке дл€ HTML файлов"
        '
        'TextBox2
        '
        ...
        Me.Label4.Text = "ѕапка XSL шаблона"
        '
        'TextBox4
        '
